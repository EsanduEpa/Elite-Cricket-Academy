...
class M_Session {
    ...
    public function getSessionsByCoach($coachId, $filters = []) {
        ...
        if (!empty($filters['search'])) {
            $query .= ' AND (s.Name LIKE :search OR s.Location LIKE :search OR sd.FacilityType LIKE :search)';
        }
    ...
    public function updateSession($id, $data) {
        ...
        $this->db->bind(':max_participants', $data['max_participants'] ?? null);
