            ...
            <div class="schedule-card calendar-card">
                <div class="card-header">
                    <div class="header-content">
                        ...
                        <div class="calendar-controls">
                            ...
                            <span id="currentWeekRange"><?php echo date('j M Y', strtotime('monday this week')); ?> - <?php echo date('j M Y', strtotime('sunday this week')); ?></span>
                            <button class="nav-btn" id="nextWeek" title="Next week">
                                <i class="fas fa-chevron-right"></i>
                            </button>
                            <button class="btn-primary" id="todayWeek" type="button" title="Go to current week">
                                Today
                            </button>
                        </div>
                    </div>
                ...
                <div class="card-content">
                    <div class="calendar-container">
                        ...
                        <div id="bookingWeekCalendar" class="cal-calendar-shell">
