...
<link rel="stylesheet" href="<?php echo URLROOT; ?>/css/admin/staff-management.css">
                ...
                <div class="staff-table-section">
                    <table class="staff-table" id="staffTable">
                        ...
                        <tbody id="staffTableBody">
                            ...
                            <?php
                                $staffRoleKey = strtolower((string)$staff->Role);
                                if ($staffRoleKey === 'shopemployee') {
                                    $staffRoleKey = 'shopkeeper';
                                }
                            ?>
                            <tr
                                data-staff-role="<?php echo htmlspecialchars($staffRoleKey); ?>"
                                data-staff-status="<?php echo htmlspecialchars(strtolower((string)$staff->Status)); ?>"
                                data-staff-search="<?php echo htmlspecialchars(strtolower(trim(($staff->Name ?? '') . ' ' . ($staff->Email ?? '') . ' ' . ($staff->Role ?? '') . ' ' . ($staff->Department ?? '')))); ?>"
                            >
    ...
    <script type="application/json" id="coachAssignedPlayersData">
    <?php echo json_encode($coachAssignedPlayers, JSON_HEX_TAG | JSON_HEX_APOS | JSON_HEX_QUOT | JSON_HEX_AMP); ?>
    </script>
    <script src="<?php echo URLROOT; ?>/js/admin/staff-page.js"></script>
</body>
</html>
