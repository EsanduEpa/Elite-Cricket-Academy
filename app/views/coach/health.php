...
<link rel="stylesheet" href="<?php echo URLROOT; ?>/css/coach-health.css">
    ...
    <!-- Add Injury Report Modal -->
    <div class="modal" id="injuryReportModal">
        <div class="modal-content large">
            <div class="modal-header">
                <h2><i class="fas fa-plus-circle"></i> Add Injury Report</h2>
                <button class="modal-close" id="closeInjuryModal">
            ...
            <div class="modal-body">
                <form id="injuryReportForm">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <select id="injuryType" required>
                                ...
                                <option value="ligament">Ligament Injury</option>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="affectedArea" placeholder="e.g., Right knee, Left shoulder" required>
                    </div>

                    <div class="form-group">
                        <label for="injuryDescription">Injury Description *</label>
                        <textarea id="injuryDescription" rows="4" placeholder="Describe the injury and circumstances..." required></textarea>
                    </div>

                    <div class="form-group">
                        <label for="restrictions">Activity Restrictions</label>
                        <textarea id="restrictions" rows="3" placeholder="List any restrictions or precautions..."></textarea>
                    </div>

                    <div class="form-row">
                        <div class="form-group">
                            <label for="estimatedRecovery">Estimated Recovery (days)</label>
                            <input type="number" id="estimatedRecovery" min="1" placeholder="e.g., 14">
                        </div>
                        <div class="form-group">
                            <label for="requiresPhysio">Requires Physiotherapy</label>
                            <select id="requiresPhysio">
                    ...
                    <div class="form-actions">
                        <button type="button" class="btn-secondary" id="cancelInjuryReport">Cancel</button>
    ...
    <div class="modal" id="healthDetailsModal">
        <div class="modal-content large">
            <div class="modal-header">
                <h2 id="healthDetailsTitle">Health Record Details</h2>
                <button class="modal-close" id="closeHealthDetailsModal">
                    <i class="fas fa-times"></i>
                </button>
            </div>
            <div class="modal-body" id="healthDetailsBody">
    ...
    <div class="modal" id="updateRecoveryModal">
        <div class="modal-content">
            <div class="modal-header">
                <h2><i class="fas fa-sync-alt"></i> Update Recovery Progress</h2>
                <button class="modal-close" id="closeUpdateRecoveryModal">
                    <i class="fas fa-times"></i>
                </button>
            </div>
            <div class="modal-body">
                <form id="updateRecoveryForm">
                    <input type="hidden" id="updateRecordId">
                    
                    <div class="form-group">
                        <label for="recoveryStatus">Status *</label>
                        <select id="recoveryStatus" required>
                            <option value="injured">Injured</option>
                            <option value="recovering">Recovering</option>
                            <option value="under_observation">Under Observation</option>
                    ...
                    <div class="form-group">
                        <label for="recoveryProgress">Recovery Progress (%) *</label>
                        <input type="range" id="recoveryProgress" min="0" max="100" value="0" required>
                        <div class="progress-value"><span id="progressValue">0</span>%</div>
                    </div>

                    <div class="form-group">
                        <label for="recoveryNotes">Recovery Notes</label>
                        <textarea id="recoveryNotes" rows="4" placeholder="Add notes about recovery progress..."></textarea>
                    </div>

                    <div class="form-actions">
                        <button type="button" class="btn-secondary" id="cancelUpdateRecovery">Cancel</button>
                        <button type="submit" class="btn-primary">
                            <i class="fas fa-save"></i>
                            Update Progress
                        </button>
