...
(256, 15, 'slot_booking', 'Booked occurrence #1169 for player #15 (source: self)', '::1', NULL, '2026-04-15 15:40:33'),
(257, 3, 'save_occurrence_attendance', 'Saved attendance roster for occurrence #2171', '::1', NULL, '2026-04-15 22:54:18'),
(258, 15, 'slot_booking', 'Booked occurrence #75 for player #15 (source: self)', '::1', NULL, '2026-04-16 08:46:45'),
(259, 15, 'slot_booking', 'Booked occurrence #1321 for player #15 (source: self)', '::1', NULL, '2026-04-16 08:50:48'),
(260, 122, 'account_created', 'New Player account created', NULL, NULL, '2026-04-16 09:35:00'),
(261, 122, 'account_created', 'New player account registered', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Code/1.115.0 Chrome/142.0.7444.265 Electron/39.8.5 Safari/537.36', '2026-04-16 09:35:01'),
(262, 8, 'private_session_request_approved', 'Reviewed private session request #1 as approved and created occurrence #2914', '::1', NULL, '2026-04-16 09:59:13'),
(263, 8, 'slot_auto_enroll', 'Auto-enrolled assigned players for occurrence #2915', '::1', NULL, '2026-04-16 10:24:47'),
(264, 8, 'slot_auto_enroll', 'Auto-enrolled assigned players for occurrence #2916', '::1', NULL, '2026-04-16 10:24:47'),
(265, 8, 'generate_occurrences', 'Generated 2 occurrence(s) for template #202 (test coach group session) from 2026-04-17 to 2026-04-24', '::1', NULL, '2026-04-16 10:24:47'),
(266, 55, 'slot_booking', 'Booked occurrence #228 for player #55 (source: self)', '::1', NULL, '2026-04-16 10:35:30'),
(267, 30, 'create_private_session_request', 'Staff requested private session #3 on 2026-04-17', '::1', NULL, '2026-04-16 10:38:31'),
(268, 30, 'create_private_session_request', 'Staff requested private session #4 on 2026-04-17', '::1', NULL, '2026-04-16 10:38:44'),
(269, 8, 'private_session_request_rejected', 'Reviewed private session request #3 as rejected', '::1', NULL, '2026-04-16 10:39:22'),
(270, 8, 'private_session_request_approved', 'Reviewed private session request #4 as approved and created occurrence #2917', '::1', NULL, '2026-04-16 10:41:00'),
(271, 8, 'generate_occurrences', 'Generated 5 occurrence(s) for template #203 (trainer session mon ) from 2026-04-27 to 2026-05-25', '::1', NULL, '2026-04-16 10:51:42'),
(272, 5, 'slot_booking', 'Booked occurrence #716 for player #15 (source: shop_employee)', '::1', NULL, '2026-04-16 11:37:26'),
(275, 15, 'stats_updated_by_coach', 'Overall stats updated by coach ID: 0 based on performance ID: 36', NULL, NULL, '2026-04-16 20:41:27'),
(276, 15, 'stats_updated_by_coach', 'Overall stats updated by coach ID: 0 based on performance ID: 37', NULL, NULL, '2026-04-16 20:43:38'),
(277, 3, 'cancel_occurrence', 'Staff cancelled occurrence #2915: sdfgb', '::1', NULL, '2026-04-16 21:22:51'),
(278, 3, 'create_private_session_request', 'Staff requested private session #5 on 2026-04-17', '::1', NULL, '2026-04-16 21:23:39'),
(279, 1, 'private_session_request_rejected', 'Reviewed private session request #5 as rejected', '::1', NULL, '2026-04-16 21:24:32');
...
(42, 9, 'batting', 'Open', 3, 1, 'Assigned by admin from staff management page', 1, '2026-04-14 14:41:41', '2026-04-18 02:01:09'),
...
(46, 3, 'fielding', 'Open', 4, 1, 'Assigned by admin from staff management page', 1, '2026-04-15 00:10:25', '2026-04-18 02:01:09'),
...
(55, 31, 'bowling', 'Open', 3, 1, 'Assigned by admin from staff management page', 1, '2026-04-15 01:15:26', '2026-04-18 02:01:09');
...
(3, 3, 60, 55, 'Wicket Keeper', 'good reaction speed', '', 'pending', NULL, NULL, '2026-04-16 04:46:54', NULL),
(4, 3, 61, 15, 'All-Rounder', 'Strong recent performance (seed).', 'Include in squad (seed).', 'approved', 'Approved (seed).', 14, '2026-03-08 05:30:00', '2026-03-09 06:30:00'),
(5, 3, 61, 6, 'Batsman', 'Consistent opener (seed).', 'Include in squad (seed).', 'approved', 'Approved (seed).', 14, '2026-03-08 05:35:00', '2026-03-09 06:35:00'),
(6, 3, 61, 7, 'Bowler', 'Wicket-taking bowler (seed).', 'Include in squad (seed).', 'approved', 'Approved (seed).', 14, '2026-03-08 05:40:00', '2026-03-09 06:40:00'),
(7, 3, 61, 16, 'Wicket-Keeper', 'Safe hands (seed).', 'Include in squad (seed).', 'approved', 'Approved (seed).', 14, '2026-03-08 05:45:00', '2026-03-09 06:45:00'),
(8, 3, 61, 18, 'Batsman', 'Middle-order stability (seed).', 'Include in squad (seed).', 'approved', 'Approved (seed).', 14, '2026-03-08 05:50:00', '2026-03-09 06:50:00'),
(9, 3, 61, 20, 'Bowler', 'Economical spells (seed).', 'Include in squad (seed).', 'approved', 'Approved (seed).', 14, '2026-03-08 05:55:00', '2026-03-09 06:55:00');
...
CREATE TABLE `crimatch` (
  ...
  `TournamentID` int(11) NOT NULL,
  `Name` varchar(100) NOT NULL COMMENT 'e.g. Semi-Final 1 or League Match 5',
  `Date` date NOT NULL,
  `Venue` varchar(255) DEFAULT NULL,
  `OpponentTeam` varchar(255) NOT NULL,
  `Result` enum('win','loss','tie','draw','no-result','abandoned','pending') DEFAULT 'pending',
  `MarginValue` int(10) UNSIGNED DEFAULT NULL COMMENT 'The number part: e.g. 5',
  `MarginType` enum('runs','wickets','super over','DLS','boundaries','forfeit') DEFAULT NULL,
  `OurRuns` smallint(5) UNSIGNED DEFAULT NULL,
  `OurWickets` tinyint(3) UNSIGNED DEFAULT NULL,
  `OpponentRuns` smallint(5) UNSIGNED DEFAULT NULL,
  `OpponentWickets` tinyint(3) UNSIGNED DEFAULT NULL,
  `IsDLS` tinyint(1) DEFAULT 0 COMMENT '1 if Duckworth-Lewis was applied',
...
INSERT INTO `crimatch` (`MatchID`, `TournamentID`, `Name`, `Date`, `Venue`, `OpponentTeam`, `Result`, `MarginValue`, `MarginType`, `OurRuns`, `OurWickets`, `OpponentRuns`, `OpponentWickets`, `IsDLS`, `SummaryNotes`, `CreatedAt`, `UpdatedAt`) VALUES
(24, 58, 'Final', '2026-08-03', 'Elite Ground 2', 'Young Titans', 'win', 3, 'wickets', 187, 7, 186, 9, 0, 'Completed Under 21 tournament final.', '2026-04-15 15:51:30', '2026-04-15 15:51:30'),
(25, 51, 'League Match 1', '2026-07-26', 'Elite Ground 1', 'Weather Watchers', 'draw', 0, NULL, 189, 7, 189, 8, 0, 'Completed Open tournament league match.', '2026-04-15 15:51:30', '2026-04-15 15:51:30'),
(26, 51, 'Final', '2026-07-27', 'Elite Ground 1', 'Weather Watchers', 'draw', 0, NULL, 189, 7, 189, 8, 0, 'Completed Open tournament final.', '2026-04-15 15:51:30', '2026-04-15 15:51:30'),
(27, 59, 'League Match 1', '2026-01-15', 'Academy Oval', 'County Rockets', 'win', 11, 'runs', 201, 6, 190, 10, 0, 'Completed Under 17 tournament league match.', '2026-04-15 20:05:27', '2026-04-15 20:07:10'),
(28, 59, 'Final', '2026-01-15', 'Academy Oval', 'County Rockets', 'win', 11, 'runs', 201, 6, 190, 10, 0, 'Completed Under 17 tournament final.', '2026-04-15 20:05:27', '2026-04-15 20:07:21'),
(29, 61, 'U17 Seed Match 1', '2026-04-09', 'Elite Ground 1', 'Colombo Juniors U17', 'win', 25, 'runs', 210, 8, 185, 10, 0, 'Won by 25 runs (seed).', '2026-04-17 11:19:10', '2026-04-17 11:19:10'),
(30, 61, 'U17 Seed Match 2', '2026-04-10', 'Elite Ground 1', 'Kandy Juniors U17', 'loss', 3, 'wickets', 198, 10, 199, 7, 0, 'Lost by 3 wickets (seed).', '2026-04-17 11:19:10', '2026-04-17 11:19:10'),
(31, 61, 'U17 Seed Final', '2026-04-10', 'Elite Ground 1', 'Galle Juniors U17', 'win', 2, 'wickets', 175, 9, 174, 10, 0, 'Won final by 2 wickets (seed).', '2026-04-17 11:19:10', '2026-04-17 11:19:10');
...
(88, NULL, 'tharush.open_07@eliteca.com', 'Welcome to Cricket Academy', 'welcome', 'queued', NULL, NULL, '2026-04-14 20:06:22'),
(89, NULL, 'kasun.open_08@eliteca.com', 'Welcome to Cricket Academy', 'welcome', 'queued', NULL, NULL, '2026-04-14 20:06:22'),
(90, NULL, 'dinesh.open_09@eliteca.com', 'Welcome to Cricket Academy', 'welcome', 'queued', NULL, NULL, '2026-04-14 20:06:22'),
(91, NULL, 'pasan.open_10@eliteca.com', 'Welcome to Cricket Academy', 'welcome', 'queued', NULL, NULL, '2026-04-14 20:06:22'),
(92, 121, 'tharuka.fielding@eliteca.com', 'Welcome to Cricket Academy', 'welcome', 'queued', NULL, NULL, '2026-04-15 00:12:15'),
(93, 122, 'vijinialm17@gmail.com', 'Welcome to Cricket Academy', 'welcome', 'queued', NULL, NULL, '2026-04-16 09:35:00'),
(94, 122, 'vijinialm17@gmail.com', 'Payment Confirmation - ELITE-122-1776312749', 'notification', 'failed', NULL, 'SMTP send failed or recipient mailbox was unavailable. Check PHP error log for Mailer details.', '2026-04-16 09:46:02'),
(95, 122, 'vijinialm17@gmail.com', 'Payment Confirmation - ELITE-122-1776313299', 'notification', 'failed', NULL, 'SMTP send failed or recipient mailbox was unavailable. Check PHP error log for Mailer details.', '2026-04-16 09:52:11'),
(96, 15, 'viniliyanamana@gmail.com', 'Payment Confirmation - ELITE-15-1776318970', 'notification', 'failed', NULL, 'SMTP send failed or recipient mailbox was unavailable. Check PHP error log for Mailer details.', '2026-04-16 11:26:54'),
(97, 15, 'viniliyanamana@gmail.com', 'Payment Confirmation - ELITE-15-1776326168', 'notification', 'failed', NULL, 'SMTP send failed or recipient mailbox was unavailable. Check PHP error log for Mailer details.', '2026-04-16 13:26:58'),
(98, NULL, '2023is053@stu.ucsc.cmb.ac.lk', 'Welcome to Cricket Academy', 'welcome', 'queued', NULL, NULL, '2026-04-16 13:41:11'),
(99, NULL, 'vijinialm17@gmail.com', 'Payment Confirmation - ELITE-90-1776327267', 'notification', 'failed', NULL, 'SMTP send failed or recipient mailbox was unavailable. Check PHP error log for Mailer details.', '2026-04-16 13:45:03'),
(100, NULL, '2023is053@stu.ucsc.cmb.ac.lk', 'Payment Confirmation - ELITE-SUB-123-75-1776327525', 'notification', 'failed', NULL, 'SMTP send failed or recipient mailbox was unavailable. Check PHP error log for Mailer details.', '2026-04-16 13:49:36'),
(101, 15, 'viniliyanamana@gmail.com', 'Session Reminder - Booking #5', 'notification', 'failed', NULL, 'SMTP send failed or recipient mailbox was unavailable. Check PHP error log for Mailer details.', '2026-04-16 15:01:08'),
(102, 15, 'viniliyanamana@gmail.com', 'Session Reminder - Booking #5', 'notification', 'failed', NULL, 'SMTP send failed or recipient mailbox was unavailable. Check PHP error log for Mailer details.', '2026-04-16 15:05:12'),
(103, 15, 'viniliyanamana@gmail.com', 'Session Reminder - Booking #5', 'notification', 'failed', NULL, 'SMTP send failed or recipient mailbox was unavailable. Check PHP error log for Mailer details.', '2026-04-16 15:07:37'),
(104, 15, 'viniliyanamana@gmail.com', 'Session Reminder - Booking #5', 'notification', 'failed', NULL, 'SMTP send failed or recipient mailbox was unavailable. Check PHP error log for Mailer details.', '2026-04-16 15:09:41'),
(105, 15, 'viniliyanamana@gmail.com', 'Session Reminder - Booking #5', 'notification', 'failed', NULL, 'SMTP send failed or recipient mailbox was unavailable. Check PHP error log for Mailer details.', '2026-04-16 15:12:32'),
(106, 15, 'viniliyanamana@gmail.com', 'Session Reminder - Booking #5', 'notification', 'failed', NULL, 'SMTP send failed or recipient mailbox was unavailable. Check PHP error log for Mailer details.', '2026-04-16 15:14:09'),
(107, 15, 'viniliyanamana@gmail.com', 'Session Reminder - Booking #5', 'notification', 'failed', NULL, 'SMTP send failed or recipient mailbox was unavailable. Check PHP error log for Mailer details.', '2026-04-16 15:14:34'),
(108, 15, 'viniliyanamana@gmail.com', 'Session Reminder - Booking #5', 'notification', 'failed', NULL, 'SMTP send failed or recipient mailbox was unavailable. Check PHP error log for Mailer details.', '2026-04-16 15:17:51'),
(109, 15, 'viniliyanamana@gmail.com', 'Session Reminder - Booking #5', 'notification', 'failed', NULL, 'SMTP send failed or recipient mailbox was unavailable. Check PHP error log for Mailer details.', '2026-04-16 15:22:03'),
(110, 15, 'viniliyanamana@gmail.com', 'Session Reminder - Booking #5', 'notification', 'failed', NULL, 'SMTP send failed or recipient mailbox was unavailable. Check PHP error log for Mailer details.', '2026-04-16 15:22:07'),
(111, 15, 'viniliyanamana@gmail.com', 'Session Reminder - Booking #5', 'notification', 'failed', NULL, 'SMTP send failed or recipient mailbox was unavailable. Check PHP error log for Mailer details.', '2026-04-16 15:22:09'),
(112, 15, 'viniliyanamana@gmail.com', 'Session Reminder - Booking #5', 'notification', 'failed', NULL, 'SMTP send failed or recipient mailbox was unavailable. Check PHP error log for Mailer details.', '2026-04-16 15:22:11'),
(113, 15, 'viniliyanamana@gmail.com', 'Session Reminder - Booking #5', 'notification', 'failed', NULL, 'SMTP send failed or recipient mailbox was unavailable. Check PHP error log for Mailer details.', '2026-04-16 15:22:16'),
(114, 15, 'viniliyanamana@gmail.com', 'Session Reminder - Booking #5', 'notification', 'failed', NULL, 'SMTP send failed or recipient mailbox was unavailable. Check PHP error log for Mailer details.', '2026-04-16 15:22:19'),
(115, 15, 'viniliyanamana@gmail.com', 'Session Reminder - Booking #5', 'notification', 'failed', NULL, 'SMTP send failed or recipient mailbox was unavailable. Check PHP error log for Mailer details.', '2026-04-16 15:22:25'),
(116, 15, 'viniliyanamana@gmail.com', 'Session Reminder - Booking #5', 'notification', 'failed', NULL, 'SMTP send failed or recipient mailbox was unavailable. Check PHP error log for Mailer details.', '2026-04-16 15:26:17'),
(117, 15, 'viniliyanamana@gmail.com', 'Session Reminder - Booking #5', 'notification', 'failed', NULL, 'SMTP send failed or recipient mailbox was unavailable. Check PHP error log for Mailer details.', '2026-04-16 15:26:19'),
(118, 15, 'viniliyanamana@gmail.com', 'Session Reminder - Booking #5', 'notification', 'failed', NULL, 'SMTP send failed or recipient mailbox was unavailable. Check PHP error log for Mailer details.', '2026-04-16 15:26:34'),
(119, 15, 'viniliyanamana@gmail.com', 'Session Reminder - Booking #5', 'notification', 'failed', NULL, 'SMTP send failed or recipient mailbox was unavailable. Check PHP error log for Mailer details.', '2026-04-16 15:28:33'),
(120, 15, 'viniliyanamana@gmail.com', 'Session Reminder - Booking #5', 'notification', 'failed', NULL, 'SMTP send failed or recipient mailbox was unavailable. Check PHP error log for Mailer details.', '2026-04-16 15:28:35'),
(121, 15, 'viniliyanamana@gmail.com', 'Session Reminder - Booking #5', 'notification', 'failed', NULL, 'SMTP send failed or recipient mailbox was unavailable. Check PHP error log for Mailer details.', '2026-04-16 15:28:35'),
(122, 15, 'viniliyanamana@gmail.com', 'Session Reminder - Booking #5', 'notification', 'failed', NULL, 'SMTP send failed or recipient mailbox was unavailable. Check PHP error log for Mailer details.', '2026-04-16 15:29:49'),
(123, 15, 'viniliyanamana@gmail.com', 'Session Reminder - Booking #5', 'notification', 'failed', NULL, 'SMTP send failed or recipient mailbox was unavailable. Check PHP error log for Mailer details.', '2026-04-16 15:29:52'),
(124, 15, 'viniliyanamana@gmail.com', 'Session Reminder - Booking #5', 'notification', 'failed', NULL, 'SMTP send failed or recipient mailbox was unavailable. Check PHP error log for Mailer details.', '2026-04-16 15:29:55'),
(125, 15, 'viniliyanamana@gmail.com', 'Session Reminder - Booking #5', 'notification', 'failed', NULL, 'SMTP send failed or recipient mailbox was unavailable. Check PHP error log for Mailer details.', '2026-04-16 15:30:03'),
(126, 15, 'viniliyanamana@gmail.com', 'Session Reminder - Booking #5', 'notification', 'failed', NULL, 'SMTP send failed or recipient mailbox was unavailable. Check PHP error log for Mailer details.', '2026-04-16 15:30:08'),
(127, 15, 'viniliyanamana@gmail.com', 'Session Reminder - Booking #5', 'notification', 'failed', NULL, 'SMTP send failed or recipient mailbox was unavailable. Check PHP error log for Mailer details.', '2026-04-16 15:33:28'),
(128, 15, 'viniliyanamana@gmail.com', 'Session Reminder - Booking #5', 'notification', 'failed', NULL, 'SMTP send failed or recipient mailbox was unavailable. Check PHP error log for Mailer details.', '2026-04-16 15:35:52'),
(129, 15, 'viniliyanamana@gmail.com', 'Session Reminder - Booking #5', 'notification', 'failed', NULL, 'SMTP send failed or recipient mailbox was unavailable. Check PHP error log for Mailer details.', '2026-04-16 15:36:06'),
(130, 15, 'viniliyanamana@gmail.com', 'Session Reminder - Booking #5', 'notification', 'failed', NULL, 'SMTP send failed or recipient mailbox was unavailable. Check PHP error log for Mailer details.', '2026-04-16 15:36:07'),
(131, 15, 'viniliyanamana@gmail.com', 'Session Reminder - Booking #5', 'notification', 'failed', NULL, 'SMTP send failed or recipient mailbox was unavailable. Check PHP error log for Mailer details.', '2026-04-16 15:36:36'),
(132, 15, 'viniliyanamana@gmail.com', 'Session Reminder - Booking #5', 'notification', 'failed', NULL, 'SMTP send failed or recipient mailbox was unavailable. Check PHP error log for Mailer details.', '2026-04-16 15:36:42'),
(133, 15, 'viniliyanamana@gmail.com', 'Session Reminder - Booking #5', 'notification', 'failed', NULL, 'SMTP send failed or recipient mailbox was unavailable. Check PHP error log for Mailer details.', '2026-04-16 15:36:52'),
(134, 15, 'viniliyanamana@gmail.com', 'Session Reminder - Booking #5', 'notification', 'failed', NULL, 'SMTP send failed or recipient mailbox was unavailable. Check PHP error log for Mailer details.', '2026-04-16 15:40:53'),
(135, 15, 'viniliyanamana@gmail.com', 'Session Reminder - Booking #5', 'notification', 'failed', NULL, 'SMTP send failed or recipient mailbox was unavailable. Check PHP error log for Mailer details.', '2026-04-16 15:41:40'),
(136, 15, 'viniliyanamana@gmail.com', 'Session Reminder - Booking #5', 'notification', 'failed', NULL, 'SMTP send failed or recipient mailbox was unavailable. Check PHP error log for Mailer details.', '2026-04-16 15:49:14'),
(137, 15, 'viniliyanamana@gmail.com', 'Session Reminder - Booking #5', 'notification', 'failed', NULL, 'SMTP send failed or recipient mailbox was unavailable. Check PHP error log for Mailer details.', '2026-04-16 15:52:10'),
(138, 15, 'viniliyanamana@gmail.com', 'Session Reminder - Booking #5', 'notification', 'failed', NULL, 'SMTP send failed or recipient mailbox was unavailable. Check PHP error log for Mailer details.', '2026-04-16 15:52:18'),
(139, 15, 'viniliyanamana@gmail.com', 'Session Reminder - Booking #5', 'notification', 'failed', NULL, 'SMTP send failed or recipient mailbox was unavailable. Check PHP error log for Mailer details.', '2026-04-16 15:55:07'),
(140, 15, 'viniliyanamana@gmail.com', 'Session Reminder - Booking #5', 'notification', 'failed', NULL, 'SMTP send failed or recipient mailbox was unavailable. Check PHP error log for Mailer details.', '2026-04-16 15:55:34'),
(141, 15, 'viniliyanamana@gmail.com', 'Session Reminder - Booking #5', 'notification', 'failed', NULL, 'SMTP send failed or recipient mailbox was unavailable. Check PHP error log for Mailer details.', '2026-04-16 15:57:52'),
(142, 15, 'viniliyanamana@gmail.com', 'Session Reminder - Booking #5', 'notification', 'failed', NULL, 'SMTP send failed or recipient mailbox was unavailable. Check PHP error log for Mailer details.', '2026-04-16 15:57:56'),
(143, 15, 'viniliyanamana@gmail.com', 'Session Reminder - Booking #5', 'notification', 'failed', NULL, 'SMTP send failed or recipient mailbox was unavailable. Check PHP error log for Mailer details.', '2026-04-16 15:58:12'),
(144, 15, 'viniliyanamana@gmail.com', 'Session Reminder - Booking #5', 'notification', 'failed', NULL, 'SMTP send failed or recipient mailbox was unavailable. Check PHP error log for Mailer details.', '2026-04-16 15:58:17'),
(145, 15, 'viniliyanamana@gmail.com', 'Session Reminder - Booking #5', 'notification', 'failed', NULL, 'SMTP send failed or recipient mailbox was unavailable. Check PHP error log for Mailer details.', '2026-04-16 15:58:24'),
(146, 15, 'viniliyanamana@gmail.com', 'Session Reminder - Booking #5', 'notification', 'failed', NULL, 'SMTP send failed or recipient mailbox was unavailable. Check PHP error log for Mailer details.', '2026-04-16 15:59:26'),
(147, 15, 'viniliyanamana@gmail.com', 'Session Reminder - Booking #5', 'notification', 'failed', NULL, 'SMTP send failed or recipient mailbox was unavailable. Check PHP error log for Mailer details.', '2026-04-16 15:59:57'),
(148, 15, 'viniliyanamana@gmail.com', 'Payment Confirmation - ELITE-15-1776360956', 'notification', 'sent', '2026-04-16 19:36:45', NULL, '2026-04-16 23:06:45');
...
CREATE TABLE `equipment` (
  ...
  `value_price` decimal(10,2) DEFAULT 0.00
...
INSERT INTO `equipment` (`EquipmentID`, `Name`, `Description`, `Category`, `AvailabilityStatus`, `RentalPrice`, `Stock`, `EqCondition`, `equipmentImage`, `value_price`) VALUES
(1, 'Cricket Bat - Professional', 'High-quality willow cricket bat', 'Batting', 'rented', 500.00, 2, 'new', 'uploads/shop_product/product_9_1761119174.png', 5000.00),
(2, 'Cricket Ball - Leather', 'Professional leather cricket ball', 'Bowling', 'available', 500.00, 3, 'new', 'uploads/shop_product/product_9_1761119174.png', 1500.00),
(3, 'Helmet - Professional', 'Safety helmet with grill', 'Protective', 'rented', 500.00, 2, 'new', 'uploads/shop_product/product_9_1761119174.png', 3500.00),
(4, 'Batting Pads', 'Professional batting pads', 'Protective', 'available', 500.00, 2, 'good', 'uploads/shop_product/product_9_1761119174.png', 1500.00),
(5, 'Wicket Keeping Gloves', 'Professional WK gloves', 'Protective', 'available', 500.00, 2, 'good', 'uploads/shop_product/product_9_1761119174.png', 1500.00);
...
CREATE TABLE `equipmentrental` (
  ...
  `AgreeToTerms` tinyint(1) NOT NULL DEFAULT 0,
...
INSERT INTO `equipmentrental` (`RentalID`, `EquipmentID`, `PlayerID`, `RentalDate`, `StartTime`, `EndTime`, `Status`, `TotalCost`, `ProcessedBy`, `AgreeToTerms`, `ReturnInspectedBy`, `ReturnNotes`, `LateFee`) VALUES
(2, 2, 15, '2026-04-16', '2026-04-16 19:47:36', '2026-04-17 19:47:36', 'returned', 500.00, 5, 0, 5, '', 750.00),
(3, 3, 20, '2026-04-17', '2026-04-17 20:17:36', '2026-04-23 20:47:36', 'active', 500.00, 5, 0, NULL, NULL, 0.00),
(5, 5, 15, '2026-04-17', '2026-04-17 20:47:36', '2026-04-18 20:47:36', 'active', 500.00, 5, 0, NULL, NULL, 0.00);
...
--
-- Table structure for table `equipmentrentalcart`
--

CREATE TABLE `equipmentrentalcart` (
  `CartID` int(11) NOT NULL,
  `PlayerID` int(11) NOT NULL,
  `EquipmentID` int(11) NOT NULL,
...
--
-- Dumping data for table `equipmentrentalcart`
--

INSERT INTO `equipmentrentalcart` (`CartID`, `PlayerID`, `EquipmentID`, `AddedDate`) VALUES
(1, 15, 4, '2026-04-17 18:42:06');

-- --------------------------------------------------------

--
-- Table structure for table `equipmentreturn`
--
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Return processing for equipment rentals (late fees, damage, inspection)';

--
-- Dumping data for table `equipmentreturn`
--

INSERT INTO `equipmentreturn` (`ReturnID`, `RentalID`, `ReturnedAt`, `ReturnStatus`, `DamageStatus`, `DamageFee`, `DaysLate`, `LateFee`, `Notes`, `InspectedBy`, `CreatedAt`, `TotalReturnPay`, `PaymentStatus`) VALUES
(1, 2, '2026-04-17 23:44:00', 'completed', 'not_damaged', 0.00, 1, 750.00, '', 5, '2026-04-17 23:45:35', 750.00, 'pending');
...
(109, 122, 'welcome', 'Welcome to Cricket Academy', 'Your account has been created successfully. Please complete your profile setup.', NULL, NULL, 0, NULL, '2026-04-16 09:35:00'),
(111, 15, 'stats_updated', 'Performance Statistics Updated', 'Your overall performance statistics have been updated based on your verified match performance.', NULL, NULL, 0, NULL, '2026-04-16 20:41:27'),
(112, 15, 'stats_updated', 'Performance Statistics Updated', 'Your overall performance statistics have been updated based on your verified match performance.', NULL, NULL, 0, NULL, '2026-04-16 20:43:38');
...
(27, 25, 16, 42, 31, 0, 0.0, 0, 1, 0, 8.5, 'verified', 16, 16, '2026-04-15 22:37:16', '2026-04-15 22:37:16', '2026-04-15 22:37:16'),
(28, 25, 18, 18, 22, 1, 4.0, 24, 0, 0, 7.8, 'verified', 18, 18, '2026-04-15 22:37:16', '2026-04-15 22:37:16', '2026-04-15 22:37:16'),
(29, 25, 20, 9, 12, 2, 4.0, 19, 0, 0, 8.9, 'verified', 20, 20, '2026-04-15 22:37:16', '2026-04-15 22:37:16', '2026-04-15 22:37:16'),
(30, 26, 21, 55, 38, 0, 0.0, 0, 1, 0, 8.7, 'verified', 21, 21, '2026-04-15 22:37:16', '2026-04-15 22:37:16', '2026-04-15 22:37:16'),
(31, 26, 22, 24, 20, 1, 4.0, 21, 1, 0, 8.0, 'verified', 22, 22, '2026-04-15 22:37:16', '2026-04-15 22:37:16', '2026-04-15 22:37:16'),
(32, 26, 25, 17, 16, 1, 4.0, 18, 0, 0, 7.6, 'verified', 25, 25, '2026-04-15 22:37:16', '2026-04-15 22:37:16', '2026-04-15 22:37:16'),
(33, 24, 52, 61, 44, 0, 0.0, 0, 1, 0, 9.1, 'verified', 52, 52, '2026-04-15 22:37:16', '2026-04-15 22:37:16', '2026-04-15 22:37:16'),
(34, 24, 53, 15, 18, 2, 4.0, 17, 1, 0, 8.3, 'verified', 53, 53, '2026-04-15 22:37:16', '2026-04-15 22:37:16', '2026-04-15 22:37:16'),
(35, 24, 54, 34, 29, 1, 3.0, 22, 0, 0, 8.0, 'verified', 54, 54, '2026-04-15 22:37:16', '2026-04-15 22:37:16', '2026-04-15 22:37:16'),
(36, 28, 15, 15, 7, 1, 2.0, 20, 1, 0, 0.0, 'verified', 15, NULL, NULL, '2026-04-16 20:24:36', '2026-04-16 20:41:27'),
(37, 27, 15, 52, 85, 2, 2.0, 15, 0, 0, 0.0, 'verified', 15, NULL, NULL, '2026-04-16 20:43:16', '2026-04-16 20:43:38'),
(38, 29, 15, 45, 38, 2, 5.0, 28, 1, 0, 8.6, 'verified', 3, 1, '2026-04-11 10:00:00', '2026-04-17 16:49:10', '2026-04-17 16:49:10'),
(40, 29, 7, 10, 12, 3, 7.0, 35, 0, 0, 7.6, 'verified', 3, 1, '2026-04-11 10:00:00', '2026-04-17 16:49:10', '2026-04-17 16:49:10'),
(41, 30, 15, 12, 18, 1, 6.0, 40, 0, 0, 5.9, 'verified', 3, 1, '2026-04-11 10:05:00', '2026-04-17 16:49:10', '2026-04-17 16:49:10'),
(42, 30, 16, 25, 22, 0, 0.0, 0, 1, 1, 7.2, 'verified', 3, 1, '2026-04-11 10:05:00', '2026-04-17 16:49:10', '2026-04-17 16:49:10'),
(43, 30, 20, 5, 9, 2, 8.0, 34, 0, 0, 7.1, 'verified', 3, 1, '2026-04-11 10:05:00', '2026-04-17 16:49:10', '2026-04-17 16:49:10'),
(44, 31, 15, 67, 60, 2, 4.0, 18, 1, 0, 9.1, 'verified', 3, 1, '2026-04-11 10:10:00', '2026-04-17 16:49:10', '2026-04-17 16:49:10'),
(45, 31, 18, 44, 39, 0, 0.0, 0, 0, 0, 7.4, 'verified', 3, 1, '2026-04-11 10:10:00', '2026-04-17 16:49:10', '2026-04-17 16:49:10'),
(46, 31, 7, 8, 10, 4, 6.0, 27, 0, 0, 8.3, 'verified', 3, 1, '2026-04-11 10:10:00', '2026-04-17 16:49:10', '2026-04-17 16:49:10'),
(47, 29, 6, 62, 55, 0, 0.0, 0, 0, 0, 7.8, 'verified', 3, 1, '2026-04-11 10:00:00', '2026-04-17 16:54:13', '2026-04-17 16:54:13');
...
(15, 15, 'Strain', 'RICE Procedure', 'ongoing', '2026-02-04', 'no', 4, 'uploads/medical_receipts/receipt_15_1771999461.pdf', '2026-02-25', 15, 'pending', 'Arm/Elbow'),
...
(54, 52, 1, 61, 0, 61, 61.00, 0.00, 138.64, 0.00, '2026-04-18 01:42:50', NULL, 0, 1, 0, 0, '0/0'),
(55, 53, 1, 15, 2, 15, 15.00, 8.50, 83.33, 4.25, '2026-04-18 01:42:50', NULL, 0, 0, 0, 0, '2/17'),
(56, 54, 1, 34, 1, 34, 34.00, 22.00, 117.24, 7.33, '2026-04-18 01:42:50', NULL, 0, 0, 0, 0, '1/22'),
...
(94, 122, 0, 0, 0, 0, 0.00, 0.00, 0.00, 0.00, '2026-04-16 09:35:00', NULL, 0, 0, 0, 0, NULL),
(96, 15, 5, 191, 8, 67, 38.20, 15.13, 91.83, 6.37, '2026-04-17 16:49:10', NULL, 0, 2, 0, 0, '2/15'),
(98, 7, 2, 18, 7, 10, 9.00, 8.86, 81.82, 4.77, '2026-04-17 16:49:10', NULL, 0, 0, 0, 1, '4/27'),
(99, 16, 2, 67, 0, 42, 33.50, 0.00, 126.42, 0.00, '2026-04-17 16:49:10', NULL, 0, 0, 0, 0, '0/0'),
(100, 18, 2, 62, 1, 44, 31.00, 24.00, 101.64, 6.00, '2026-04-17 16:49:10', NULL, 0, 0, 0, 0, '1/24'),
(101, 20, 2, 14, 4, 9, 7.00, 13.25, 66.67, 4.42, '2026-04-17 16:49:10', NULL, 0, 0, 0, 0, '2/19'),
(105, 6, 1, 62, 0, 62, 62.00, 0.00, 112.73, 0.00, '2026-04-17 16:54:13', NULL, 0, 1, 0, 0, '0/0'),
(111, 28, 0, 0, 0, 0, 0.00, 0.00, 0.00, 0.00, '2026-04-18 01:42:50', NULL, 0, 0, 0, 0, 'N/A');
...
(6, NULL, NULL, NULL, 'basic', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
...
(122, NULL, NULL, NULL, 'basic', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
(75, 122, 1, '2026-04-16', NULL, 'active', 4500.00, 1, 1, '2026-04-16 09:35:00', '2026-04-16 09:35:00', NULL, NULL, NULL);
...
(6, 'batting', 30, 'Open', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(6, 'bowling', 12, 'Open', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(6, 'fielding', 121, 'Open', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(7, 'batting', 30, 'Open', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(7, 'bowling', 12, 'Open', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(7, 'fielding', 121, 'Open', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(15, 'batting', 27, 'Under 17', 'auto_registration', NULL, '2026-04-17 23:13:23', 'Assigned automatically during registration'),
(15, 'bowling', 31, 'Under 17', 'auto_registration', NULL, '2026-04-17 23:13:23', 'Assigned automatically during registration'),
(15, 'fielding', 3, 'Under 17', 'auto_registration', NULL, '2026-04-17 23:13:23', 'Assigned automatically during registration'),
(16, 'batting', 30, 'Open', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(16, 'bowling', 12, 'Open', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(16, 'fielding', 121, 'Open', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(18, 'batting', 30, 'Open', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(18, 'bowling', 12, 'Open', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(18, 'fielding', 121, 'Open', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(20, 'batting', 30, 'Open', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(20, 'bowling', 12, 'Open', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(20, 'fielding', 121, 'Open', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(21, 'batting', 30, 'Open', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(21, 'bowling', 12, 'Open', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(21, 'fielding', 121, 'Open', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(22, 'batting', 30, 'Open', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(22, 'bowling', 12, 'Open', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(22, 'fielding', 121, 'Open', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(25, 'batting', 30, 'Open', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(25, 'bowling', 12, 'Open', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(25, 'fielding', 121, 'Open', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(26, 'batting', 9, 'Under 13', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(26, 'bowling', 11, 'Under 13', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(26, 'fielding', 121, 'Under 13', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(28, 'batting', 27, 'Under 19', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(28, 'bowling', 31, 'Under 19', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(28, 'fielding', 3, 'Under 19', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(29, 'batting', 9, 'Under 13', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(29, 'bowling', 11, 'Under 13', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(29, 'fielding', 121, 'Under 13', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(32, 'batting', 9, 'Under 13', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(32, 'bowling', 11, 'Under 13', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(32, 'fielding', 121, 'Under 13', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(33, 'batting', 9, 'Under 13', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(33, 'bowling', 11, 'Under 13', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(33, 'fielding', 121, 'Under 13', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(34, 'batting', 9, 'Under 13', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(34, 'bowling', 11, 'Under 13', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(34, 'fielding', 121, 'Under 13', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(35, 'batting', 9, 'Under 13', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(35, 'bowling', 11, 'Under 13', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(35, 'fielding', 121, 'Under 13', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(36, 'batting', 9, 'Under 13', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(36, 'bowling', 11, 'Under 13', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(36, 'fielding', 121, 'Under 13', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(37, 'batting', 9, 'Under 15', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(37, 'bowling', 11, 'Under 15', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(37, 'fielding', 3, 'Under 15', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(38, 'batting', 9, 'Under 15', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(38, 'bowling', 11, 'Under 15', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(38, 'fielding', 3, 'Under 15', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(39, 'batting', 9, 'Under 15', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(39, 'bowling', 11, 'Under 15', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(39, 'fielding', 3, 'Under 15', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(40, 'batting', 9, 'Under 15', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(40, 'bowling', 11, 'Under 15', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(40, 'fielding', 3, 'Under 15', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(41, 'batting', 9, 'Under 15', 'auto_registration', NULL, '2026-04-16 00:31:55', 'Assigned automatically during registration'),
(41, 'bowling', 11, 'Under 15', 'auto_registration', NULL, '2026-04-16 00:31:55', 'Assigned automatically during registration'),
(41, 'fielding', 3, 'Under 15', 'auto_registration', NULL, '2026-04-16 00:31:55', 'Assigned automatically during registration'),
(42, 'batting', 27, 'Under 17', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(42, 'bowling', 31, 'Under 17', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(42, 'fielding', 3, 'Under 17', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(43, 'batting', 27, 'Under 17', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(43, 'bowling', 31, 'Under 17', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(43, 'fielding', 3, 'Under 17', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(44, 'batting', 27, 'Under 17', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(44, 'bowling', 31, 'Under 17', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(44, 'fielding', 3, 'Under 17', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(45, 'batting', 27, 'Under 17', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(45, 'bowling', 31, 'Under 17', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(45, 'fielding', 3, 'Under 17', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(46, 'batting', 27, 'Under 17', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(46, 'bowling', 31, 'Under 17', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(46, 'fielding', 3, 'Under 17', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(47, 'batting', 27, 'Under 19', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(47, 'bowling', 31, 'Under 19', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(47, 'fielding', 3, 'Under 19', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(48, 'batting', 27, 'Under 19', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(48, 'bowling', 31, 'Under 19', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(48, 'fielding', 3, 'Under 19', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(49, 'batting', 27, 'Under 19', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(49, 'bowling', 31, 'Under 19', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(49, 'fielding', 3, 'Under 19', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(50, 'batting', 27, 'Under 19', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(50, 'bowling', 31, 'Under 19', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(50, 'fielding', 3, 'Under 19', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(51, 'batting', 27, 'Under 19', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(51, 'bowling', 31, 'Under 19', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(51, 'fielding', 3, 'Under 19', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(52, 'batting', 9, 'Open', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(52, 'bowling', 31, 'Open', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(52, 'fielding', 3, 'Open', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(53, 'batting', 9, 'Open', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(53, 'bowling', 31, 'Open', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(53, 'fielding', 3, 'Open', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(54, 'batting', 9, 'Open', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(54, 'bowling', 31, 'Open', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(54, 'fielding', 3, 'Open', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(55, 'batting', 9, 'Open', 'auto_registration', NULL, '2026-04-16 10:32:43', 'Assigned automatically during registration'),
(55, 'bowling', 31, 'Open', 'auto_registration', NULL, '2026-04-16 10:32:43', 'Assigned automatically during registration'),
(55, 'fielding', 3, 'Open', 'auto_registration', NULL, '2026-04-16 10:32:43', 'Assigned automatically during registration'),
(56, 'batting', 9, 'Open', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(56, 'bowling', 31, 'Open', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(56, 'fielding', 3, 'Open', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(57, 'batting', 30, 'Under 11', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(57, 'bowling', 12, 'Under 11', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(57, 'fielding', 121, 'Under 11', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(58, 'batting', 9, 'Under 13', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(58, 'bowling', 11, 'Under 13', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(58, 'fielding', 121, 'Under 13', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(59, 'batting', 9, 'Under 13', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(59, 'bowling', 11, 'Under 13', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(59, 'fielding', 121, 'Under 13', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(60, 'batting', 9, 'Under 13', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(60, 'bowling', 11, 'Under 13', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(60, 'fielding', 121, 'Under 13', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(61, 'batting', 9, 'Under 13', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(61, 'bowling', 11, 'Under 13', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(61, 'fielding', 121, 'Under 13', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(62, 'batting', 9, 'Under 15', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(62, 'bowling', 11, 'Under 15', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(62, 'fielding', 3, 'Under 15', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(63, 'batting', 9, 'Under 15', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(63, 'bowling', 11, 'Under 15', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(63, 'fielding', 3, 'Under 15', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(64, 'batting', 9, 'Under 15', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(64, 'bowling', 11, 'Under 15', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(64, 'fielding', 3, 'Under 15', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(65, 'batting', 9, 'Under 15', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(65, 'bowling', 11, 'Under 15', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(65, 'fielding', 3, 'Under 15', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(66, 'batting', 9, 'Under 15', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(66, 'bowling', 11, 'Under 15', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(66, 'fielding', 3, 'Under 15', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(67, 'batting', 27, 'Under 17', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(67, 'bowling', 31, 'Under 17', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(67, 'fielding', 3, 'Under 17', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(68, 'batting', 27, 'Under 17', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(68, 'bowling', 31, 'Under 17', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(68, 'fielding', 3, 'Under 17', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(69, 'batting', 27, 'Under 17', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(69, 'bowling', 31, 'Under 17', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(69, 'fielding', 3, 'Under 17', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(70, 'batting', 27, 'Under 17', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(70, 'bowling', 31, 'Under 17', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(70, 'fielding', 3, 'Under 17', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(71, 'batting', 27, 'Under 17', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(71, 'bowling', 31, 'Under 17', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(71, 'fielding', 3, 'Under 17', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(72, 'batting', 27, 'Under 19', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(72, 'bowling', 31, 'Under 19', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(72, 'fielding', 3, 'Under 19', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(73, 'batting', 27, 'Under 19', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(73, 'bowling', 31, 'Under 19', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(73, 'fielding', 3, 'Under 19', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(74, 'batting', 27, 'Under 19', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(74, 'bowling', 31, 'Under 19', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(74, 'fielding', 3, 'Under 19', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(75, 'batting', 9, 'Open', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(75, 'bowling', 31, 'Open', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(75, 'fielding', 3, 'Open', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(76, 'batting', 27, 'Under 19', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(76, 'bowling', 31, 'Under 19', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(76, 'fielding', 3, 'Under 19', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(77, 'batting', 9, 'Open', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(77, 'bowling', 31, 'Open', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(77, 'fielding', 3, 'Open', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(78, 'batting', 9, 'Open', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(78, 'bowling', 31, 'Open', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(78, 'fielding', 3, 'Open', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(79, 'batting', 9, 'Open', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(79, 'bowling', 31, 'Open', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(79, 'fielding', 3, 'Open', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(80, 'batting', 9, 'Open', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(80, 'bowling', 31, 'Open', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(80, 'fielding', 3, 'Open', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(81, 'batting', 9, 'Open', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(81, 'bowling', 31, 'Open', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(81, 'fielding', 3, 'Open', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(82, 'batting', 30, 'Open', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(82, 'bowling', 12, 'Open', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(82, 'fielding', 121, 'Open', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(83, 'batting', 30, 'Open', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(83, 'bowling', 12, 'Open', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(83, 'fielding', 121, 'Open', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(84, 'batting', 30, 'Open', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(84, 'bowling', 12, 'Open', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(84, 'fielding', 121, 'Open', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(85, 'batting', 30, 'Open', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(85, 'bowling', 12, 'Open', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(85, 'fielding', 121, 'Open', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(86, 'batting', 30, 'Open', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(86, 'bowling', 12, 'Open', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(86, 'fielding', 121, 'Open', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(87, 'batting', 30, 'Open', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(87, 'bowling', 12, 'Open', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(87, 'fielding', 121, 'Open', 'system_refresh', NULL, '2026-04-15 12:17:44', 'Rebuilt from coach skill age-group assignments'),
(122, 'batting', 9, 'Under 15', 'auto_registration', NULL, '2026-04-16 09:35:13', 'Assigned automatically during registration'),
(122, 'bowling', 11, 'Under 15', 'auto_registration', NULL, '2026-04-16 09:35:13', 'Assigned automatically during registration'),
(122, 'fielding', 3, 'Under 15', 'auto_registration', NULL, '2026-04-16 09:35:13', 'Assigned automatically during registration');
...
(15, 'Performance Batting Gloves (Pair)', 'Breathable batting gloves with reinforced palm and flexible finger protection.', 'Batting', 'Elite', 1900.00, 18, 'active', NULL, 0.260, '30 x 15 x 8 cm', '2026-04-01 08:22:59', NULL, 'uploads/shop_product/product_9_1761119174.png'),
(16, 'Cricket Helmet with Steel Grill', 'Lightweight protective helmet with adjustable strap and impact-absorbing inner padding.', 'Protective', 'Elite', 4200.00, 11, 'active', 'HLMT-ELITE-003', 0.820, '35 x 25 x 25 cm', '2026-04-01 08:22:59', NULL, 'uploads/shop_product/product_9_1761119174.png'),
...
INSERT INTO `productcart` (`CartID`, `PlayerID`, `ProductID`, `Quantity`, `AddedDate`) VALUES
(4, 15, 15, 1, '2026-04-17 18:41:39');
...
(22, 15, '2026-04-16 13:26:58', 0, NULL, 1900.00, 'online', 'completed', NULL, NULL, NULL),
(24, 15, '2026-04-16 23:06:39', 0, NULL, 4200.00, 'online', 'completed', NULL, NULL, NULL);
...
(15, 22, 15, 1, 1900.00, 1900.00),
(17, 24, 16, 1, 4200.00, 4200.00);
...
(114, 'booking', 3, 'create', NULL, NULL, 'confirmed', 'self', 15, '2026-04-15 15:40:33', '::1'),
(115, 'occurrence', 2171, 'update', 'Attendance', NULL, 'saved', 'Attendance roster updated', 3, '2026-04-15 22:54:18', '::1'),
(116, 'booking', 4, 'create', NULL, NULL, 'confirmed', 'self', 15, '2026-04-16 08:46:45', '::1'),
(117, 'booking', 5, 'create', NULL, NULL, 'confirmed', 'self', 15, '2026-04-16 08:50:48', '::1'),
(118, 'occurrence', 2915, 'create', NULL, NULL, 'scheduled', NULL, 8, '2026-04-16 10:24:47', '::1'),
(119, 'occurrence', 2916, 'create', NULL, NULL, 'scheduled', NULL, 8, '2026-04-16 10:24:47', '::1'),
(120, 'booking', 6, 'create', NULL, NULL, 'confirmed', 'self', 55, '2026-04-16 10:35:30', '::1'),
(121, 'occurrence', 2918, 'create', NULL, NULL, 'scheduled', NULL, 8, '2026-04-16 10:51:42', '::1'),
(122, 'occurrence', 2919, 'create', NULL, NULL, 'scheduled', NULL, 8, '2026-04-16 10:51:42', '::1'),
(123, 'occurrence', 2920, 'create', NULL, NULL, 'scheduled', NULL, 8, '2026-04-16 10:51:42', '::1'),
(124, 'occurrence', 2921, 'create', NULL, NULL, 'scheduled', NULL, 8, '2026-04-16 10:51:42', '::1'),
(125, 'occurrence', 2922, 'create', NULL, NULL, 'scheduled', NULL, 8, '2026-04-16 10:51:42', '::1'),
(126, 'booking', 7, 'create', NULL, NULL, 'confirmed', 'shop_employee', 5, '2026-04-16 11:37:26', '::1'),
(127, 'occurrence', 2915, 'cancel', 'Status', 'scheduled', 'cancelled', 'sdfgb', 3, '2026-04-16 21:22:51', '::1');
...
(3, 1169, 15, 'self', 1, NULL, 'confirmed', 1, 0.00, 'not_required', NULL, NULL, 15, NULL, NULL, NULL, '2026-04-15 15:40:33', '2026-04-15 15:40:33'),
(4, 75, 15, 'self', 1, NULL, 'confirmed', 1, 0.00, 'not_required', NULL, NULL, 15, NULL, NULL, NULL, '2026-04-16 08:46:45', '2026-04-16 08:46:45'),
(5, 1321, 15, 'self', 1, NULL, 'confirmed', 1, 0.00, 'not_required', NULL, NULL, 15, NULL, NULL, NULL, '2026-04-16 08:50:48', '2026-04-16 08:50:48'),
(6, 228, 55, 'self', 29, NULL, 'confirmed', 1, 2500.00, 'paid', '', NULL, 55, NULL, NULL, NULL, '2026-04-16 10:35:30', '2026-04-16 10:35:30'),
(7, 716, 15, 'shop_employee', NULL, NULL, 'confirmed', 1, 2500.00, 'paid', 'cash', NULL, 5, NULL, NULL, NULL, '2026-04-16 11:37:26', '2026-04-16 11:37:26');
...
(2914, NULL, 3, '2026-04-16', 4, NULL, 'scheduled', NULL, 10, 'Approved private session request', 8, '2026-04-16 09:59:13'),
(2915, 202, 1, '2026-04-17', 4, NULL, 'cancelled', 'sdfgb', NULL, NULL, 8, '2026-04-16 10:24:47'),
(2916, 202, 1, '2026-04-24', 4, NULL, 'scheduled', NULL, NULL, NULL, 8, '2026-04-16 10:24:47'),
(2917, NULL, 2, '2026-04-17', 4, NULL, 'scheduled', NULL, 10, 'Approved private session request', 8, '2026-04-16 10:41:00'),
(2918, 203, 1, '2026-04-27', 6, NULL, 'scheduled', NULL, NULL, NULL, 8, '2026-04-16 10:51:42'),
(2919, 203, 1, '2026-05-04', 6, NULL, 'scheduled', NULL, NULL, NULL, 8, '2026-04-16 10:51:42'),
(2920, 203, 1, '2026-05-11', 6, NULL, 'scheduled', NULL, NULL, NULL, 8, '2026-04-16 10:51:42'),
(2921, 203, 1, '2026-05-18', 6, NULL, 'scheduled', NULL, NULL, NULL, 8, '2026-04-16 10:51:42'),
(2922, 203, 1, '2026-05-25', 6, NULL, 'scheduled', NULL, NULL, NULL, 8, '2026-04-16 10:51:42');

-- --------------------------------------------------------

--
-- Table structure for table `slot_occurrence_attendance`
--

CREATE TABLE `slot_occurrence_attendance` (
...
--
-- Dumping data for table `slot_occurrence_attendance`
--

INSERT INTO `slot_occurrence_attendance` (`AttendanceID`, `OccurrenceID`, `PlayerID`, `AttendanceStatus`, `MarkedBy`, `MarkedAt`) VALUES
(1, 2171, 68, 'present', 3, '2026-04-15 22:54:18'),
(2, 2171, 44, 'present', 3, '2026-04-15 22:54:18'),
(3, 2171, 46, 'present', 3, '2026-04-15 22:54:18'),
(4, 2171, 71, 'present', 3, '2026-04-15 22:54:18'),
(5, 2171, 70, 'present', 3, '2026-04-15 22:54:18'),
(6, 2171, 67, 'present', 3, '2026-04-15 22:54:18'),
(7, 2171, 43, 'present', 3, '2026-04-15 22:54:18'),
(8, 2171, 42, 'absent', 3, '2026-04-15 22:54:18'),
(9, 2171, 69, 'present', 3, '2026-04-15 22:54:18'),
(10, 2171, 45, 'present', 3, '2026-04-15 22:54:18');
...
INSERT INTO `slot_occurrence_staff_override` (`ID`, `OccurrenceID`, `UserID`, `StaffType`, `OverridesUserID`, `OverrideReason`) VALUES
(1, 2159, 3, 'coach', NULL, 'Approved from private session request #2'),
(2, 2914, 3, 'coach', NULL, 'Approved from private session request #1'),
(3, 2917, 30, 'coach', NULL, 'Approved from private session request #4');
...
(1, 3, 'coach', 3, '2026-04-16', 4, 10, '', 'approved', NULL, 8, '2026-04-16 09:59:13', 2914, '2026-04-14 21:50:02', '2026-04-16 09:59:13'),
(2, 3, 'coach', 2, '2026-04-23', 4, 10, '', 'approved', NULL, 8, '2026-04-14 22:55:26', 2159, '2026-04-14 21:50:22', '2026-04-14 22:55:26'),
(3, 30, 'coach', 1, '2026-04-17', 4, 10, '', 'rejected', NULL, 8, '2026-04-16 10:39:22', NULL, '2026-04-16 10:38:31', '2026-04-16 10:39:22'),
(4, 30, 'coach', 2, '2026-04-17', 4, 10, '', 'approved', NULL, 8, '2026-04-16 10:41:00', 2917, '2026-04-16 10:38:44', '2026-04-16 10:41:00'),
(5, 3, 'coach', 1, '2026-04-17', 4, 10, '', 'rejected', NULL, 1, '2026-04-16 21:24:32', NULL, '2026-04-16 21:23:39', '2026-04-16 21:24:32');
...
(196, 'Under 21 Batting Group - Practice Net 1', 'U21-BAT-PN1', 'program', 'coach', 1, 6, 1, 'Open', 'batting', 'Weekly Under 21 batting group session at Practice Net 1', 0, 0.00, 'sessions', 1, 1, '2026-04-15 01:55:23', '2026-04-18 02:01:09'),
(197, 'Under 21 Bowling Group - Bowling Machine', 'U21-BOWL-BM', 'program', 'coach', 4, 2, 3, 'Open', 'bowling', 'Weekly Under 21 bowling group session at Bowling Machine', 0, 0.00, 'sessions', 1, 1, '2026-04-15 01:55:23', '2026-04-18 02:01:09'),
(198, 'Under 21 Fielding Group - Main Ground', 'U21-FLD-MG', 'program', 'coach', 4, 3, 4, 'Open', 'fielding', 'Weekly Under 21 fielding group session at Main Ground', 0, 0.00, 'sessions', 1, 1, '2026-04-15 01:55:23', '2026-04-18 02:01:09'),
...
(202, 'test coach group session', 'test-coach-grp', 'program', 'coach', 1, 5, 4, 'Open', 'Fielding', '', NULL, 0.00, 'sessions', 1, 8, '2026-04-16 10:22:14', '2026-04-18 02:01:09'),
(203, 'trainer session mon ', 'TRI-FIT-MON', 'private', 'trainer', 1, 1, 6, 'Under 15', 'Fitness', '', NULL, 0.00, 'facility_access', 1, 8, '2026-04-16 10:50:44', '2026-04-16 10:57:09');
...
--
-- Dumping data for table `slot_template_player_assignment`
--

INSERT INTO `slot_template_player_assignment` (`TemplateID`, `PlayerID`, `CoachingType`, `AgeGroup`, `AssignmentSource`, `AssignedBy`, `AssignedAt`, `IsActive`, `Notes`) VALUES
(187, 41, 'batting', 'Under 15', 'auto_plan', NULL, '2026-04-16 00:31:55', 1, 'Auto-assigned from player skill coach assignment and age group'),
(187, 122, 'batting', 'Under 15', 'auto_plan', NULL, '2026-04-16 09:35:13', 1, 'Auto-assigned from player skill coach assignment and age group'),
(188, 41, 'bowling', 'Under 15', 'auto_plan', NULL, '2026-04-16 00:31:55', 1, 'Auto-assigned from player skill coach assignment and age group'),
(188, 122, 'bowling', 'Under 15', 'auto_plan', NULL, '2026-04-16 09:35:13', 1, 'Auto-assigned from player skill coach assignment and age group'),
(189, 41, 'fielding', 'Under 15', 'auto_plan', NULL, '2026-04-16 00:31:55', 1, 'Auto-assigned from player skill coach assignment and age group'),
(189, 122, 'fielding', 'Under 15', 'auto_plan', NULL, '2026-04-16 09:35:13', 1, 'Auto-assigned from player skill coach assignment and age group'),
(190, 15, 'batting', 'Under 17', 'auto_plan', NULL, '2026-04-17 23:13:23', 1, 'Auto-assigned from player skill coach assignment and age group'),
(191, 15, 'bowling', 'Under 17', 'auto_plan', NULL, '2026-04-17 23:13:23', 1, 'Auto-assigned from player skill coach assignment and age group'),
(192, 15, 'fielding', 'Under 17', 'auto_plan', NULL, '2026-04-17 23:13:23', 1, 'Auto-assigned from player skill coach assignment and age group'),
(196, 55, 'batting', 'Open', 'auto_plan', NULL, '2026-04-16 10:32:43', 1, 'Auto-assigned from player skill coach assignment and age group'),
(197, 55, 'bowling', 'Open', 'auto_plan', NULL, '2026-04-16 10:32:43', 1, 'Auto-assigned from player skill coach assignment and age group'),
(198, 55, 'fielding', 'Open', 'auto_plan', NULL, '2026-04-16 10:32:43', 1, 'Auto-assigned from player skill coach assignment and age group'),
(199, 15, 'batting', 'Under 17', 'auto_plan', NULL, '2026-04-17 23:13:23', 1, 'Auto-assigned from player skill coach assignment and age group'),
(199, 41, 'batting', 'Under 15', 'auto_plan', NULL, '2026-04-16 00:31:55', 1, 'Auto-assigned from player skill coach assignment and age group'),
(199, 55, 'batting', 'Open', 'auto_plan', NULL, '2026-04-16 10:32:43', 1, 'Auto-assigned from player skill coach assignment and age group'),
(199, 122, 'batting', 'Under 15', 'auto_plan', NULL, '2026-04-16 09:35:13', 1, 'Auto-assigned from player skill coach assignment and age group'),
(200, 15, 'bowling', 'Under 17', 'auto_plan', NULL, '2026-04-17 23:13:23', 1, 'Auto-assigned from player skill coach assignment and age group'),
(200, 41, 'bowling', 'Under 15', 'auto_plan', NULL, '2026-04-16 00:31:55', 1, 'Auto-assigned from player skill coach assignment and age group'),
(200, 55, 'bowling', 'Open', 'auto_plan', NULL, '2026-04-16 10:32:43', 1, 'Auto-assigned from player skill coach assignment and age group'),
(200, 122, 'bowling', 'Under 15', 'auto_plan', NULL, '2026-04-16 09:35:13', 1, 'Auto-assigned from player skill coach assignment and age group'),
(201, 15, 'fielding', 'Under 17', 'auto_plan', NULL, '2026-04-17 23:13:23', 1, 'Auto-assigned from player skill coach assignment and age group'),
(201, 41, 'fielding', 'Under 15', 'auto_plan', NULL, '2026-04-16 00:31:55', 1, 'Auto-assigned from player skill coach assignment and age group'),
(201, 55, 'fielding', 'Open', 'auto_plan', NULL, '2026-04-16 10:32:43', 1, 'Auto-assigned from player skill coach assignment and age group'),
(201, 122, 'fielding', 'Under 15', 'auto_plan', NULL, '2026-04-16 09:35:13', 1, 'Auto-assigned from player skill coach assignment and age group'),
(202, 55, 'fielding', 'Open', 'auto_plan', NULL, '2026-04-16 10:32:43', 1, 'Auto-assigned from player skill coach assignment and age group');
...
(149, 202, 3, 'coach', 'lead', 8, '2026-04-16 10:22:24'),
(150, 203, 4, 'trainer', 'lead', 8, '2026-04-16 10:57:29');
...
(74, 75, NULL, 4500.00, 'online', 'pending', NULL, 'manual', NULL, NULL, '2026-04-16', NULL, 'Membership is pending. Pay to experience the whole academy services.', '2026-04-16 09:35:00', '2026-04-16 09:35:00', NULL, NULL, NULL);
...
(6, 'Monsoon Cricket League', 'Under 13', 'T20', '', '2026-06-15', '2026-05-15', 20, 'Riverside Cricket Ground', 1, 'registration_open', 0, NULL, '2026-04-10 11:01:59', '2026-04-17 12:06:09', 30000.00),
(7, 'Premier Division T20', 'Under 15', 'T20', NULL, '2026-04-01', NULL, NULL, 'Central Stadium', 1, 'cancelled', 0, 'Auto-fix: tournament date passed with no recorded activity.', '2026-04-10 11:01:59', '2026-04-17 12:06:09', 80000.00),
(8, 'Academy Invitational Cup', 'Under 17', 'T20', NULL, '2026-06-07', '2026-05-07', NULL, 'Training Complex A', 1, 'registration_open', 0, NULL, '2026-04-10 11:01:59', '2026-04-17 12:06:09', 20000.00),
(9, 'District Cricket Championship', 'Under 19', 'T20', NULL, '2026-02-28', NULL, NULL, 'District Sports Arena', 1, 'cancelled', 0, 'Auto-fix: tournament date passed with no recorded activity.', '2026-04-10 11:01:59', '2026-04-17 12:06:09', 40000.00),
(10, 'Veterans Cricket Tournament', 'Open', 'T20', NULL, '2026-03-15', NULL, NULL, 'Memorial Ground', 1, 'cancelled', 0, 'Auto-fix: tournament date passed with no recorded activity.', '2026-04-10 11:01:59', '2026-04-17 20:31:09', 10000.00),
(11, 'Under 11 Created Cup', 'Under 11', 'T20', 'Under 11 tournament in created state.', '2026-08-15', NULL, 14, 'Main Ground', 1, 'created', 0, NULL, '2026-04-15 10:35:28', '2026-04-15 16:12:40', 0.00),
(18, 'Under 13 Created Cup', 'Under 13', 'T20', 'Under 13 tournament in created state.', '2026-07-30', NULL, 16, 'North Ground', 1, 'created', 0, NULL, '2026-04-15 10:35:28', '2026-04-15 16:13:12', 0.00),
(19, 'Under 13 Registration Open Cup', 'Under 13', 'T20', 'Under 13 tournament with registration open.', '2026-06-23', '2026-06-18', 16, 'North Ground', 1, 'registration_open', 0, NULL, '2026-04-15 10:35:28', '2026-04-15 10:35:28', 0.00),
(26, 'Under 15 Registration Open Cup', 'Under 15', 'T20', 'Under 15 tournament with registration open.', '2026-07-02', '2026-06-17', 18, 'City Stadium', 1, 'registration_open', 0, NULL, '2026-04-15 10:35:28', '2026-04-15 16:13:32', 0.00),
(34, 'Under 17 Registration Closed Cup', 'Under 17', 'ODI', 'Under 17 tournament with registration closed.', '2026-06-08', '2026-05-08', 18, 'Academy Oval', 1, 'registration_closed', 0, NULL, '2026-04-15 10:35:28', '2026-04-17 12:06:09', 0.00),
(42, 'Under 19 Squad Announced Cup', 'Under 19', 'T20', 'Under 19 tournament with team announced.', '2026-04-20', '2026-04-13', 20, 'National Ground', 1, 'team_announced', 1, NULL, '2026-04-15 10:35:28', '2026-04-15 16:11:15', 15000.00),
(51, 'Open Completed Cup', 'Open', 'T20', 'Open age-group completed tournament.', '2026-04-01', '2026-03-23', 22, 'Elite Ground 1', 1, 'completed', 1, NULL, '2026-04-15 10:35:29', '2026-04-15 16:05:19', 20000.00),
(52, 'Open Cancelled Cup', 'Open', 'T20', 'Open age-group cancelled tournament.', '2026-07-28', '2026-07-23', 22, 'Elite Ground 1', 1, 'cancelled', 0, 'Weather disruption', '2026-04-15 10:35:29', '2026-04-15 10:35:29', 0.00),
(56, 'Under 21 Squad Announced Cup', 'Open', 'T20', 'Under 21 tournament with team announced.', '2026-05-01', '2026-04-14', 22, 'Elite Ground 2', 1, 'team_announced', 1, NULL, '2026-04-15 15:51:29', '2026-04-17 20:31:09', 12000.00),
(58, 'Under 21 Completed Cup', 'Open', 'T20', 'Under 21 completed tournament.', '2026-02-03', '2026-01-26', 22, 'Elite Ground 2', 1, 'completed', 1, NULL, '2026-04-15 15:51:29', '2026-04-17 20:31:09', 25000.00),
(59, 'Under 17 Completed Cup', 'Under 17', 'ODI', 'Under 17 completed tournament.', '2026-01-15', '2026-01-01', 18, 'Academy Oval', 1, 'completed', 1, NULL, '2026-04-15 20:05:27', '2026-04-15 20:06:42', 20000.00),
(60, 'u21 champions cup', 'Open', 'ODI', '', '2026-06-06', '2026-05-06', 20, 'UOC main ground', 8, 'registration_open', 0, NULL, '2026-04-16 04:37:38', '2026-04-17 20:31:09', 50000.00),
(61, 'U17 April Completed Seed Tournament', 'Under 17', 'ODI', 'Seeded completed Under-17 tournament with matches, squad, results, and performance records.', '2026-04-10', '2026-03-10', 18, 'Elite Ground 1', 1, 'completed', 1, NULL, '2026-04-17 11:19:09', '2026-04-17 11:19:09', 10000.00);
...
INSERT INTO `tournamentplayer` (`TournamentPlayerID`, `TournamentID`, `PlayerID`, `Team`, `RoleInTeam`, `SelectedBy`, `SelectionStatus`, `SelectedAt`) VALUES
(1, 61, 15, 'Elite U17', 'Captain', 14, 'confirmed', '2026-03-27 12:30:00'),
(2, 61, 6, 'Elite U17', 'Batsman', 14, 'confirmed', '2026-03-27 12:30:00'),
(3, 61, 7, 'Elite U17', 'Bowler', 14, 'confirmed', '2026-03-27 12:30:00'),
(4, 61, 16, 'Elite U17', 'Wicket-Keeper', 14, 'confirmed', '2026-03-27 12:30:00'),
(5, 61, 18, 'Elite U17', 'Batsman', 14, 'confirmed', '2026-03-27 12:30:00'),
(6, 61, 20, 'Elite U17', 'Bowler', 14, 'confirmed', '2026-03-27 12:30:00');
...
(3, 8, 15, '', 'pending', NULL, NULL, '2026-04-15 18:41:56', NULL),
(4, 26, 41, '', 'pending', NULL, NULL, '2026-04-15 19:01:35', NULL),
(5, 60, 55, '', 'pending', NULL, NULL, '2026-04-16 04:43:06', NULL),
(6, 61, 15, 'Request to join (seed).', 'approved', 1, 'Approved (seed).', '2026-03-05 03:30:00', '2026-03-06 04:30:00'),
(7, 61, 6, 'Request to join (seed).', 'approved', 1, 'Approved (seed).', '2026-03-05 03:35:00', '2026-03-06 04:35:00'),
(8, 61, 7, 'Request to join (seed).', 'approved', 1, 'Approved (seed).', '2026-03-05 03:40:00', '2026-03-06 04:40:00'),
(9, 61, 16, 'Request to join (seed).', 'approved', 1, 'Approved (seed).', '2026-03-05 03:45:00', '2026-03-06 04:45:00'),
(10, 61, 18, 'Request to join (seed).', 'approved', 1, 'Approved (seed).', '2026-03-05 03:50:00', '2026-03-06 04:50:00'),
(11, 61, 20, 'Request to join (seed).', 'approved', 1, 'Approved (seed).', '2026-03-05 03:55:00', '2026-03-06 04:55:00');
...
CREATE TABLE `tournament_result` (
  ...
  `TotalMatchesPlayed` tinyint(3) UNSIGNED DEFAULT 0,
  `TotalWins` tinyint(3) UNSIGNED DEFAULT 0,
  `TotalLosses` tinyint(3) UNSIGNED DEFAULT 0,
...
INSERT INTO `tournament_result` (`ResultID`, `TournamentID`, `Position`, `TotalMatchesPlayed`, `TotalWins`, `TotalLosses`, `ManOfTournament`, `BestBatsman`, `BestBowler`, `SummaryNotes`, `EnteredBy`, `CreatedAt`) VALUES
(1, 51, '1st runners up', 2, 0, 0, NULL, NULL, NULL, 'Open Completed Cup result summary.', 1, '2026-04-15 16:38:58'),
(2, 58, 'champions', 1, 1, 0, NULL, NULL, NULL, 'Under 21 Completed Cup result summary.', 1, '2026-04-15 16:38:58'),
(3, 61, 'champions', 3, 2, 1, 15, 15, 7, 'Seed result: champions with 3 matches played; includes full squad + verified performances.', 1, '2026-04-17 11:19:10');
...
--
-- Dumping data for table `trainer_tournament_recommendations`
--

INSERT INTO `trainer_tournament_recommendations` (`RecommendationID`, `TrainerID`, `TournamentID`, `PlayerID`, `RecommendedRole`, `Reason`, `Comments`, `Status`, `ReviewedBy`, `DateRecommended`, `DateReviewed`) VALUES
(1, 4, 8, 15, '', 'good fitness', '', 'pending', NULL, '2026-04-16 05:49:13', NULL);
...
(15, 'Shenel', 'Perera', '2010-01-01', '0765945665', 'viniliyanamana@gmail.com', 'Academy Address', 'Elite Cricket Academy', 'Player', 'Shenel', '$2y$10$H3uHJ/sg391b2RHe53sS7OXxkfeQPNkI0wLj72yBp8V2yK.zwtrmO', '2025-10-19 21:30:13', 'active', 0, NULL, NULL, 0, NULL, NULL, NULL, 'uploads/profile_images/profile_15_1761129401.jpeg'),
...
(30, 'Coach', 'Niroshan', '1988-05-14', '0771112201', 'niroshan.coach@eliteca.com', 'Academy HQ', 'Elite Cricket Academy', 'Coach', 'coach201', '$2y$10$4fc4wwrmrhezhOZbiEhkpeiAtYqGo9qyrjqmfIWFHFWQHoCeWsCW.', '2026-04-14 13:13:04', 'active', 0, NULL, NULL, 0, NULL, 1, 'Sample batting coach', NULL),
...
(41, 'Imeth', 'Weerasinghe', '2011-12-30', '0772001015', 'imeth.u15_05@eliteca.com', 'Colombo', 'Elite Cricket Academy', 'Player', 'u15_imeth05', '$2y$10$GRp2kkIsZrxUpd4K7wYBPeKsbaglUaVQRWMN7vdYFsCAKAPf4gogq', '2026-04-14 15:13:50', 'active', 0, NULL, NULL, 0, NULL, 1, 'Seed player - Under 15', NULL),
...
(122, 'Geenod', 'Induwara', '2012-02-23', '0745687123', 'vijinialm1@gmail.com', '123/1 , flower road, panadura', 'Royal college', 'Player', 'geenod', '$2y$10$9bkD1DQuj2p5tU.Q0i2XDOK3Dv/IAVZei6I4IJsanOeZ72vV9nl5S', '2026-04-16 09:35:00', 'active', 0, NULL, NULL, 0, NULL, NULL, NULL, NULL);
...
--
-- Indexes for table `equipmentrentalcart`
--
ALTER TABLE `equipmentrentalcart`
  ADD PRIMARY KEY (`CartID`),
  ADD UNIQUE KEY `uq_equipmentrentalcart_item` (`PlayerID`,`EquipmentID`),
  ADD KEY `idx_equipmentrentalcart_player` (`PlayerID`),
  ADD KEY `idx_equipmentrentalcart_equipment` (`EquipmentID`);

--
-- Indexes for table `equipmentreturn`
--
ALTER TABLE `equipmentreturn`
  ADD PRIMARY KEY (`ReturnID`),
  ADD UNIQUE KEY `uq_equipmentreturn_rental` (`RentalID`),
  ADD KEY `idx_equipmentreturn_damage` (`DamageStatus`),
  ADD KEY `idx_equipmentreturn_status` (`ReturnStatus`),
  ADD KEY `idx_equipmentreturn_returnedat` (`ReturnedAt`),
  ADD KEY `fk_equipmentreturn_inspectedby` (`InspectedBy`),
...
--
-- Indexes for table `slot_occurrence_attendance`
--
ALTER TABLE `slot_occurrence_attendance`
  ADD PRIMARY KEY (`AttendanceID`),
  ADD UNIQUE KEY `uq_slot_occurrence_attendance` (`OccurrenceID`,`PlayerID`),
  ADD KEY `idx_slot_occurrence_attendance_occurrence` (`OccurrenceID`),
  ADD KEY `idx_slot_occurrence_attendance_player` (`PlayerID`),
  ADD KEY `idx_slot_occurrence_attendance_marked_by` (`MarkedBy`);
...
ALTER TABLE `tournament_result`
  ...
  ADD UNIQUE KEY `uq_result_tournament` (`TournamentID`),
  ADD KEY `fk_tr_man` (`ManOfTournament`),
  ADD KEY `fk_tr_batsman` (`BestBatsman`),
  ADD KEY `fk_tr_bowler` (`BestBowler`);
...
--
ALTER TABLE `activitylog`
  MODIFY `ActivityID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=280;
...
--
ALTER TABLE `coach_tournament_recommendations`
  MODIFY `RecommendationID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `crimatch`
  MODIFY `MatchID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;

--
-- AUTO_INCREMENT for table `emaillog`
--
ALTER TABLE `emaillog`
  MODIFY `EmailID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=149;
...
--
-- AUTO_INCREMENT for table `equipmentrentalcart`
--
ALTER TABLE `equipmentrentalcart`
  MODIFY `CartID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `equipmentreturn`
--
ALTER TABLE `equipmentreturn`
...
--
ALTER TABLE `playeroverallstats`
  MODIFY `StatsID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=112;

--
-- AUTO_INCREMENT for table `playersubscription`
--
ALTER TABLE `playersubscription`
  MODIFY `SubscriptionID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=77;
...
--
ALTER TABLE `slot_occurrence`
  MODIFY `OccurrenceID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2923;

--
-- AUTO_INCREMENT for table `slot_occurrence_attendance`
--
ALTER TABLE `slot_occurrence_attendance`
...
--
ALTER TABLE `slot_template`
  MODIFY `TemplateID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=204;
...
--
ALTER TABLE `tournament`
  MODIFY `TournamentID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=62;

--
-- AUTO_INCREMENT for table `tournamentplayer`
--
ALTER TABLE `tournamentplayer`
  MODIFY `TournamentPlayerID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `trainer_tournament_recommendations`
  MODIFY `RecommendationID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- Constraints for table `equipmentrentalcart`
--
ALTER TABLE `equipmentrentalcart`
  ADD CONSTRAINT `fk_equipmentrentalcart_equipment` FOREIGN KEY (`EquipmentID`) REFERENCES `equipment` (`EquipmentID`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_equipmentrentalcart_player` FOREIGN KEY (`PlayerID`) REFERENCES `user` (`UserID`) ON DELETE CASCADE;

--
-- Constraints for table `equipmentreturn`
--
ALTER TABLE `equipmentreturn`
  ADD CONSTRAINT `fk_equipmentreturn_inspectedby` FOREIGN KEY (`InspectedBy`) REFERENCES `shopemployeeprofile` (`ShopEmployeeID`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_equipmentreturn_rental` FOREIGN KEY (`RentalID`) REFERENCES `equipmentrental` (`RentalID`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
-- Constraints for table `slot_occurrence_attendance`
--
ALTER TABLE `slot_occurrence_attendance`
  ADD CONSTRAINT `fk_slot_occurrence_attendance_marked_by` FOREIGN KEY (`MarkedBy`) REFERENCES `user` (`UserID`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_slot_occurrence_attendance_occurrence` FOREIGN KEY (`OccurrenceID`) REFERENCES `slot_occurrence` (`OccurrenceID`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_slot_occurrence_attendance_player` FOREIGN KEY (`PlayerID`) REFERENCES `user` (`UserID`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
-- Constraints for table `tournament_result`
--
ALTER TABLE `tournament_result`
  ADD CONSTRAINT `fk_tr_batsman` FOREIGN KEY (`BestBatsman`) REFERENCES `user` (`UserID`),
  ADD CONSTRAINT `fk_tr_bowler` FOREIGN KEY (`BestBowler`) REFERENCES `user` (`UserID`),
  ADD CONSTRAINT `fk_tr_man` FOREIGN KEY (`ManOfTournament`) REFERENCES `user` (`UserID`),
  ADD CONSTRAINT `fk_tr_tournament` FOREIGN KEY (`TournamentID`) REFERENCES `tournament` (`TournamentID`) ON DELETE CASCADE;
