...
-- NOTE: Removed invalid empty stand-in table definition that caused
--       syntax errors on import. The actual view is created later
--       in this script.
