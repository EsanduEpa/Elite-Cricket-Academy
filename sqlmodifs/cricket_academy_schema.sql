...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 22, 2025 at 06:41 PM
...
(3, 15, '2025-10-22', 'team snakes ghy', 'elite league', 'wwwww', 'pending', '2025-10-22 21:09:22', '2025-10-22 21:09:32'),
...
(2, 'gnbv', 'Trial', 'youth', NULL, '2025-10-22 05:01:00', '2025-10-31 15:52:00', 'ghfg', 'upcoming', '2025-10-30 11:52:00', '2025-10-28 11:52:00', 'hghfchj', 'e@gmail.com', '0147852963', 4, NULL),
...
(8, 'wert', 'qweryy', 'Batting', 'lol', 222222.00, 23, 'active', 'df', 5.000, '3x6x7x', '2025-10-22 13:14:55', NULL, NULL),
(9, 'sssssss', 'sss', 'Protective', 'www', 99999999.99, 22, 'active', 'd', 22.000, '222', '2025-10-22 13:16:14', NULL, 'uploads/shop_product/product_9_1761119174.png');
...
(4, 'Coaching', 'Group', 1, 'u15 batting', '2025-10-23', '10:29:00', '15:30:00', 'ground', 'active', 10, 0.00, 1);
...
(1, 'Admin User', '1990-01-01', '+1234567890', 'admin@cricketacademy.com', 'Academy Headquarters', NULL, 'Admin', 'admin', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '2025-10-18 13:02:42', 'active', 0, NULL, NULL, 0, NULL, NULL, NULL, NULL),
...
(15, 'Swairi', '1990-01-01', '+1234567890', 'swairi@eliteca.com', 'Academy Address', 'Elite Cricket Academy', 'Player', 'Swairi', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '2025-10-19 21:30:13', 'active', 0, NULL, NULL, 0, NULL, NULL, NULL, 'uploads/profile_images/profile_15_1761129401.jpeg'),
...
INSERT INTO `workoutplan` (`PlanID`, `TrainerID`, `workoutname`, `frequency`, `Duration`, `CreatedDate`) VALUES
(2, 10, 'cardio yuyiuj', 'Bi-weekly', 60, '2025-10-21'),
(4, 10, 'cardio90', 'Daily', 15, '2025-10-22'),
(24, 10, 'Manual Test Workout', 'Daily', 60, '2025-10-22'),
(25, 10, 'Manual Test Workout 20', 'Daily', 60, '2025-10-22');
...
--
ALTER TABLE `activitylog`
  MODIFY `ActivityID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
...
--
ALTER TABLE `emaillog`
  MODIFY `EmailID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
...
--
ALTER TABLE `playeroverallstats`
  MODIFY `StatsID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
