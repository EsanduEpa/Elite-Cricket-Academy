// Coach Events JavaScript - Elite Cricket Academy
...
// Coach Events Initialization
function initializeCoachEvents() {
    // Calendar navigation
    ...
    console.log('Coach Events page initialized');
}
...
function showAllEvents(type) {
    ...
    // TODO: Implement modal to show all events
}
...
// View event details (coach has read-only access)
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="event-detail-card">
                    ...
                    <p><strong>Status:</strong> Coach View (Read Only)</p>
                    <p><i class="fas fa-info-circle"></i> Detailed event information would be loaded here</p>
                </div>
            </div>
...
// Sidebar functionality for coach
